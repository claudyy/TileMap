...
public class EditorCoroutine
{
	...
	public static void ShowCoroutineProgressBar(string title, EditorCoroutine coroutine, BaseLevelGenerator g) {
		#if (UNITY_EDITOR)
		if (coroutine != null && !coroutine.IsDone){
                ...
                //	}
                //}
            if (EditorUtility.DisplayCancelableProgressBar(title, "", g.GetProgress())) {
                        coroutine.Stop();
                }
        } else {
